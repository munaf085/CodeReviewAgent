...
- STRICT TEST ENFORCEMENT (BACKEND): ALWAYS check if new backend code (logic, APIs, schemas) has accompanying unit tests in the diff. If backend tests are missing, you MUST leave a comment demanding them. For frontend/UI changes, unit tests are optional unless complex logic is introduced.
